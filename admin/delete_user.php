...
if(isset($_GET['id'])) {
    ...
    if(mysqli_errno($connection)) {
        $_SESSION['delete_user'] = "Không thể xóa người dùng {$user['lastname']} {$user['firstname']}.";
    } else {
        $_SESSION['delete_user_success'] = "Người dùng {$user['lastname']} {$user['firstname']} đã được xóa thành công.";
    }
}
